                    ...
                    <div class="sidebar-content">
                        <div class="nav-container">
                            <nav id="main-menu-navigation" class="navigation-main">
                                ...
                                <div class="nav-item @yield('menulist')">
                                    <a href="{{ route('menulist.index') }}"><i class="ik ik-menu"></i><span>Menulist</span> <!-- <span class="badge badge-success">New</span> --></a>
                                </div>
                                <div class="nav-item @yield('category')">
                                    <a href="{{ route('category.index') }}"><i class="ik ik-layers"></i><span>Category</span></a>
                                </div>
                                
                                <div class="nav-item @yield('subCategory')">
                                    <a href="{{ route('subCategory.index') }}"><i class="ik ik-box"></i><span>Sub Category</span></a>
                                </div>
                                <div class="nav-item has-sub @yield('product')">
                                    <a href="#"><i class="ik ik-gitlab"></i><span>Products</span> <span class="badge badge-success">New</span></a>
                                    <div class="submenu-content">
                                        <a href="{{ route('product.index') }}" class="menu-item">Product List</a>
                                        <a href="{{ route('product.create') }}" class="menu-item">Add New Product</a>
                                        <a href="pages/ui/carousel.html" class="menu-item">Product Multiple Photo</a>
                                    </div>
                                </div>
                                
                                <div class="nav-item @yield('brand')">
                                    <a href="{{ route('brand.index') }}"><i class="ik ik-command"></i><span>Brands</span></a>
                                </div>

                                <div class="nav-item @yield('tag')">
                                    <a href="{{ route('tag.index') }}"><i class="ik ik-command"></i><span>Tags </span></a>
                                </div>
