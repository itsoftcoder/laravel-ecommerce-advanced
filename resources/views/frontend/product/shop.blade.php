                            ...
                            <div class="sidebar-widget mb-45">
                                ...
                                <div class="sidebar-categories">
                                    <ul>
                                        ...
                                        <li><a href="#">{{ Str::title($category->name) }}<span>  @foreach ($category->subCategorys as $subCategory)
                                ...
                                <div class="shop-bar pb-60">
                                    <div class="shop-found-selector">
                                        <div class="shop-found">
                                            <p><span>23</span> Product Found of <span>{{ $products->total() }}</span></p>
                                        </div>
                                                ...
                                                <div class="product-wrapper mb-30">
                                                    <div class="product-img">
                                                        <a href="{{ route('product_details',$product->slug) }}">
                                                            <img src="{{ Storage::url('public/uploads/product-photos/'.$product->product_thumbnail) }}" alt="" height="200px">
                                                        </a>
                                                    ...
                                                    <div class="product-content">
                                                        <h4><a href="{{ route('product_details',$product->slug) }}">{{ Str::title($product->product_name) }} </a></h4>
                                                        <strong>{{ Str::title($product->subCategory->name) }}</strong><br>
                                                ...
                                                <div class="product-wrapper mb-30 single-product-list product-list-right-pr mb-60">
                                                    ...
                                                    <div class="product-content-list">
                                                        <div class="product-list-info">
                                                            <h4><a href="{{ route('product_details',$product->slug) }}">{{ Str::title($product->product_name) }}</a></h4>
                                                            <span>${{ $product->product_price }}</span>
                                                            <p>{{ Str::words($product->short_description,10) }} </p>
                                                        </div>
